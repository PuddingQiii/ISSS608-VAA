...
Install and launch the R packages: scales, viridis, lubridate, ggthemes, gridExtra, readxl, knitr, data.table and tidyverse.
...
In this section, I will show how to plot a calender heatmap programmatically by using ggplot2 package.

![](images/image01.png){fig-align="center"}
...
## **3.6 Plotting Multiple Calendar Heatmaps**
...
In this section, I will show how to plot a cycle plot showing the time-series patterns and trend of visitor arrivals from Vietnam programmatically by using ggplot2 functions.
...
In this section I will show how to plot a [slopegraph](https://www.storytellingwithdata.com/blog/2020/7/27/what-is-a-slopegraph) by using R.
