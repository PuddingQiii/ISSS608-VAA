...
# **3 [Programming Interactive Data Visualisation with R]{.underline}**
...
# **4 [Programming Animated Statistical Graphics with R]{.underline}**

# **4.1 Overview**

When telling a visually-driven data story, animated graphics tends to attract the interest of the audience and make deeper impression than static graphics. In this hands-on exercise, I will show how to create animated data visualisation by using **gganimate** and **plotly r** packages. At the same time, I will also show how to (i) reshape data by using **tidyr** package, and (ii) process, wrangle and transform data by using **dplyr** package.
